...
To install `scTypeEval` from Bioconductor:
...
sceval <- Run.Dissimilarity(sceval, method="Pseudobulk:Euclidean", reduction=TRUE)

# Get consistency
results <- get.Consistency(sceval, 
...
consistency <- get.Consistency(sceval, 
                              dissimilarity.slot="Pseudobulk:Euclidean",
                              Consistency.metric="silhouette")
```
...
sceval <- Run.Dissimilarity(sceval, method="Pseudobulk:Euclidean", reduction=TRUE)
sceval <- Run.Dissimilarity(sceval, method="Pseudobulk:Cosine", reduction=TRUE)
sceval <- Run.Dissimilarity(sceval, method="WasserStein", reduction=TRUE)
...
comparison <- lapply(methods, function(m) {
  get.Consistency(sceval, dissimilarity.slot=m, Consistency.metric="silhouette")
})
...
1. **Visualize** using `plot.Heatmap()` or `plot.PCA()` to identify problematic samples
